...
RSpec.describe PostsController, type: :controller do
  ...
  let(:other_user) { User.create!(name: RandomData.random_name, email: RandomData.random_email, password: "helloword", role: :member) }
  ...
  context "guest user" do
    ...
    describe "PUT update" do
      it "returns http redirect" do
        ...
        put :update, params: { topic_id: my_topic.id, id: my_post.id, porst: { title: new_title, body: new_body } }
        expect(response).to redirect_to(new_session_path)
      end
    end
  ...
  context "member user doing CRUD on a post they own" do
    ...
    describe "PUT update" do
      ...
      it "redirectsto the updated post" do
        new_title = RandomData.random_sentence
        new_body = RandomData.random_paragraph
