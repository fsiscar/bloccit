...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "GET new" do
    ...
    it "increases the number of Question by 1" do
      expect{ question :create, params: { question: { title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: [true, false].sample } } }
    end

    it "assigns the new question to @question" do
       question :create, params: { question: { title: RandomData.random_sentence, body: RandomData.random_paragraph, resolved: [true, false].sample } }
